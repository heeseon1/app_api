...
const SignUp = () => {
    ...
    const handleSignUp = async () => {
        const djServer = 'http://192.168.1.103:8000/accounts/dj-rest-auth/registration/';
        ...
        const csrfResponse = await axios.get('http://192.168.1.103:8000/accounts/get-csrf-token/');
